...
scores <- rbind(
  load_scores("WD Naive",      "Human", "NR--WD_38484--GS_Dataset.tsv",  "PP_NR--WD_38484--GS_Dataset.tsv",  "PR_NR--WD_38484--GS_Dataset.tsv"),
  load_scores("WD Knowledge",  "Human", "KR--WD_40717--GS_Dataset.tsv",  "PP_KR--WD_40717--GS_Dataset.tsv",  "PR_KR--WD_40717--GS_Dataset.tsv"),
  load_scores("AD Naive",      "Human", "NR--AD_40674--GS_Dataset.tsv",  "PP_NR--AD_40674--GS_Dataset.tsv",  "PR_NR--AD_40674--GS_Dataset.tsv"),
  load_scores("AD Knowledge",  "Human", "KR--AD_40718--GS_Dataset.tsv",  "PP_KR--AD_40718--GS_Dataset.tsv",  "PR_KR--AD_40718--GS_Dataset.tsv"),
  load_scores("NI Naive",      "Human", "NR--NI_40676--GS_Dataset.tsv",  "PP_NR--NI_40676--GS_Dataset.tsv",  "PR_NR--NI_40676--GS_Dataset.tsv"),
  load_scores("NI Knowledge",  "Human", "KR--NI_40716--GS_Dataset.tsv",  "PP_KR--NI_40716--GS_Dataset.tsv",  "PR_KR--NI_40716--GS_Dataset.tsv"),
  ...
  # ---- AI agents vs GS ----
  load_scores("Claude 4.6",    "AI",    "AI--Claude_46_R2--GS_Dataset.tsv",  "PP_AI--Claude_46_R2--GS_Dataset.tsv",  "PR_AI--Claude_46_R2--GS_Dataset.tsv"),
  load_scores("GPT 5.4",       "AI",    "AI--GPT_54_R2--GS_Dataset.tsv",     "PP_AI--GPT_54_R2--GS_Dataset.tsv",     "PR_AI--GPT_54_R2--GS_Dataset.tsv")
  # ---- Add new agent curators here ----
)

# Melt to long format
scores_long <- melt(scores, id.vars = c("Annotator", "Type"),
...
annotator_order <- c(
  "WD Naive", "WD Knowledge",
  "AD Naive", "AD Knowledge",
  "NI Naive", "NI Knowledge",
  "SCP Best",
  "Claude 4.6",
  "GPT 5.4"
)
...
# Compute human curator mean per metric for reference lines
human_means <- ddply(score_summary[score_summary$Type == "Human", ], .(Metric), summarise,
                     HumanMean = mean(Mean))
```

```{r results-figure, fig.cap="Mean similarity scores (with 95% CI) for each annotator vs. the Gold Standard, across four metrics. Dashed line indicates the human curator mean.", fig.height=7, fig.width=10}
